  ...
  return <>
    <form onSubmit={submit} noValidate className="w-full">
      <div className="flex flex-col gap-2 rounded-xl border border-slate-300 bg-white p-1.5 shadow-[0_8px_24px_rgba(15,23,42,.06)] sm:flex-row">
        ...
        <Button type="submit" disabled={isSubmitting} className="shrink-0 px-6">Request access</Button>
      </div>
    </form>
    {toast && <div className="fixed inset-x-4 top-[90px] z-[60] flex justify-center" role="status" aria-live="polite">

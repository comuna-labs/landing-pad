...
export function Hero() {
  return <section id="top" className="relative mx-auto grid max-w-6xl gap-14 px-6 pb-20 pt-16 lg:grid-cols-[.92fr_1.08fr] lg:items-center lg:gap-12 lg:pb-28 lg:pt-14">
    <div className="relative z-10 max-w-xl">
      ...
      <h1 className="mt-7 text-[46px] font-bold leading-[1.05] tracking-[-0.055em] text-ink sm:text-6xl lg:text-[64px]">Software your<br className="hidden lg:block" /> team builds<br /><span className="text-indigo-500">together.</span></h1>
      <p className="mt-5 max-w-lg text-base leading-7 text-slate-600 sm:text-lg">Meet commons. A shared workspace for small software teams to create, own, and improve internal tools with AI. No code required.</p>
